...
from src import kernels,utilstorch,gpobject,choosesamples
...
#Choose samples testing
samples = choosesamples.choose_samples_grid((xtrain,ytrain),kernel,
                                            noisekernel,positives,
